...
class Deals_Manager {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_dm_generate_lead_referrals_report', $plugin_admin, 'dm_generate_lead_referrals_report' );
		$this->loader->add_action( 'admin_post_dm_export_lead_referrals', $plugin_admin, 'handle_lead_referrals_export' );
