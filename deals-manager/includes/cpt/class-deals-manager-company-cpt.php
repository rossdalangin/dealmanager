...
class Deals_Manager_Company_CPT {
    ...
    public function run() {
        ...
        $this->loader->add_action( 'save_post_company', $this, 'save_meta_data' );
    }
    ...
    public function save_meta_data( $post_id ) {
        if ( ! isset( $_POST['company_details_meta_box_nonce'] ) || ! wp_verify_nonce( $_POST['company_details_meta_box_nonce'], 'company_details_meta_box' ) ) {
            return;
        }
